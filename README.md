...
This repository contains a selection of real-world benchmark datasets for [multi-label classification](https://en.wikipedia.org/wiki/Multi-label_classification). They are provided in the [Mulan data format](http://mulan.sourceforge.net/format.html) or the [LIBSVM dataset format](https://www.csie.ntu.edu.tw/~cjlin/libsvmtools/datasets/) and originate from the publicly available collections of datasets that are provided by the following projects:

* The [MEKA](https://waikato.github.io/meka/datasets) project
* The [MULAN](http://mulan.sourceforge.net/datasets-mlc.html) project
* The [LIBSVM](https://www.csie.ntu.edu.tw/~cjlin/libsvm/) project
